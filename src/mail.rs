...
//         Разобранным письмо считается по «+++» в первой строке — ставит человек или, пачкой,
//         роутер по просьбе панели. Письма при этом остаются в .inbox, никуда не переносятся.
// END_MODULE_CONTRACT
//
// START_MODULE_MAP
