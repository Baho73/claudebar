...
- **Real logos**: ready-made icons ship in [`assets/mail-icons/`](assets/mail-icons/) — copy them to
  `%APPDATA%\claudebar\mail-icons\` and the panel picks them up on the next start. A new source key
